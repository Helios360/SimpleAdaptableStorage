<script lang="ts">
    import logo from '$lib/assets/LogoBleuOmbre-edited.png';
...
<header>
    <img src={logo} height="80px" alt="AJ-Formation" />
    <div class="settings">
        <button aria-label="settings" id="cog" class:open={menuOpen} onclick={toggleMenu}>
            <svg fill="var(--secondary)" width="70" height="70" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
        ...
        <button 
            ...
            out:fly={{x: 50, duration: 500, easing: cubicOut, opacity: 0  }}
        >
